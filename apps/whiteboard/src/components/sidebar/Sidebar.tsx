...
const SwitchIconButton = ({active, disabled, activeSlot, inactiveSlot, ...props}: React.ComponentProps<'button'> & {active?: boolean; disabled?: boolean; activeSlot: React.ReactNode; inactiveSlot: React.ReactNode}) => (
	<button
		type='button'
		className={clsx(
		...
		>
			...
			>
				{context.layers.map(layer => (
					<Reorder.Item key={layer.uuid} value={layer} className='flex w-full items-center space-x-1 rounded-lg bg-gray-200/50 p-1 backdrop-blur hover:bg-gray-200/80'>
						<SwitchIconButton
							active={layer.visible}
							activeSlot={<svg xmlns='http://www.w3.org/2000/svg' width='1rem' height='1rem' viewBox='0 0 24 24'><path fill='currentColor' d='M1.182 12C2.122 6.88 6.608 3 12 3c5.392 0 9.878 3.88 10.819 9c-.94 5.12-5.427 9-10.819 9c-5.392 0-9.878-3.88-10.818-9ZM12 17a5 5 0 1 0 0-10a5 5 0 0 0 0 10Zm0-2a3 3 0 1 1 0-6a3 3 0 0 1 0 6Z'/></svg>}
							inactiveSlot={<svg xmlns='http://www.w3.org/2000/svg' width='1rem' height='1rem' viewBox='0 0 24 24'><path fill='currentColor' d='M4.52 5.935L1.394 2.808l1.414-1.414l19.799 19.798l-1.414 1.415l-3.31-3.31A10.949 10.949 0 0 1 12 21c-5.392 0-9.878-3.88-10.818-9A10.982 10.982 0 0 1 4.52 5.935Zm10.238 10.237l-1.464-1.464a3 3 0 0 1-4.001-4.001L7.829 9.243a5 5 0 0 0 6.929 6.929ZM7.974 3.76C9.221 3.27 10.58 3 12 3c5.392 0 9.878 3.88 10.819 9a10.947 10.947 0 0 1-2.012 4.593l-3.86-3.86a5 5 0 0 0-5.68-5.68L7.975 3.76Z'/></svg>}
